...
<body>
	...
	<s:form action="compute.action" method="post">
		<s:textfield key="payroll.name" label="Name" size="25"></s:textfield>
		<s:textfield key="payroll.hoursWorked" label="Hours Worked" size="5"></s:textfield>
		<s:textfield key="payroll.ratePerHour" label="Rate Per Hour" size="5"></s:textfield> 
